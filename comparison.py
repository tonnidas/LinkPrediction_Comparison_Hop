...
def do(data_name, s, graph = None):
    ...
    (
        ...
        labels_train,
        labels_model_selection,
    ) = train_test_split(examples, labels, train_size=0.75, test_size=0.25, random_state=s)
